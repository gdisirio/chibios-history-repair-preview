...
PLATFORMSRC := $(CHIBIOS)/os/xhal/ports/common/ARMCMx/nvic.c \
               $(CHIBIOS)/os/xhal/ports/STM32/STM32G0xx/stm32_isr.c \
               $(CHIBIOS)/os/xhal/ports/STM32/STM32G0xx/hal_lld.c \
               $(CHIBIOS)/os/xhal/ports/STM32/STM32G0xx/hal_efl_lld.c

# Required include directories.
PLATFORMINC := $(CHIBIOS)/os/xhal/ports/common/ARMCMx \
               $(CHIBIOS)/os/xhal/ports/STM32/STM32G0xx
