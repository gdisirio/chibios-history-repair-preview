 ...
 */
#if !defined(STM32L4xx_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32L4xx_XMCUCONF not defined"
#endif

#if defined(STM32L4P5xx) && !defined(STM32L4P5_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32L4P5_XMCUCONF not defined"

#elif defined(STM32L4Q5xx) && !defined(STM32L4Q5_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32L4Q5_XMCUCONF not defined"

#elif defined(STM32L4R5xx) && !defined(STM32L4R5_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32L4R5_XMCUCONF not defined"

#elif defined(STM32L4S5xx) && !defined(STM32L4S5_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32L4S5_XMCUCONF not defined"

#elif defined(STM32L4R7xx) && !defined(STM32L4R7_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32L4R7_XMCUCONF not defined"

#elif defined(STM32L4S7xx) && !defined(STM32L4S7_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32L4S7_XMCUCONF not defined"

#elif defined(STM32L4R9xx) && !defined(STM32L4R9_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32L4R9_XMCUCONF not defined"

#elif defined(STM32L4S9xx) && !defined(STM32L4S9_XMCUCONF)
#error "Using a wrong xmcuconf.h file, STM32L4S9_XMCUCONF not defined"
