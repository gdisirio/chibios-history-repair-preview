...
/**
 * @file    STM32C5xx/cmparams.h
 * @brief   ARM Cortex-M33 parameters for the STM32C5xx.
 *
 * @defgroup ARMCMx_STM32C5xx STM32C5xx Specific Parameters
...
#if !defined(STM32C531xx) && !defined(STM32C532xx) &&                       \
    !defined(STM32C542xx) && !defined(STM32C551xx) &&                       \
    !defined(STM32C552xx) && !defined(STM32C562xx) &&                       \
    !defined(STM32C591xx) && !defined(STM32C593xx) &&                       \
    !defined(STM32C5A3xx)
#include "board.h"
#endif
